            ...
            <div className="min-h-screen flex items-center justify-center  px-4"  style={{
                ...
                <div className="w-full max-w-2xl bg-rose-200 rounded-2xl shadow-2xl overflow-hidden">
                    <div className="flex flex-col md:flex-row">
                        ...
                        <div className="md:w-1/2 bg-rose-600 p-12 text-white hidden lg:flex flex-col justify-center">
                        ...
                        <div className="md:w-1/2 p-8">
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                                <div>
                                    <label className="block text-gray-800 text-sm font-semibold mb-2">Full Name</label>
                                    <input
                                        type="text"
