        ...
        <div className="flex items-center m-4 ">
            <div className="md:w-10/12 text-wrap mx-auto">
                <div className="relative inline-block">
                    ...
                    <div className="">
                        <Link to='/donation'><button onClick={() => handleDonateAmount()} className="rounded-md text-white font-bold hover:text-neutral-700 absolute bottom-20 left-6 px-4  hover:scale-x-110 duration-300 py-2" style={{ backgroundColor: viewStyles.backGround, color: viewStyles.textColor }}>Donate {donate_amount}</button></Link>
                    </div>
                </div>
